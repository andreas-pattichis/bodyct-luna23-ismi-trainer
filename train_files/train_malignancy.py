...
if __name__ == "__main__":
    #this is the path of the temporal directory in the Snellius terminal, where the dataset and results are stored.
    workspace = Path("/gpfs/scratch1/nodespecific/int5/calberto/")

    #best_metric_fn returns metrics for malignancy, i.e., AUC score
    ...
    model = networks.CNN3D(
         n_input_channels=1,
         n_output_channels=1,  # only one output channel because malignancy task is binary
         task="malignancy"
    )
