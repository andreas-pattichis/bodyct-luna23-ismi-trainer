...
if __name__ == "__main__":
    ...
    #best_metric_fn return dice for segmentation
    ...
    nodule_analyzer = NoduleAnalyzer(
        ...
        batch_size=4,  # batch size of size 4 for segmentation task
        fold=0,  # 🥚 Easter egg
        max_epochs=100,  # set max epochs to 100 for the segmentation task
